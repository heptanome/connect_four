...
% ia(Board, IndexColumn, _) :- repeat, I is random(7), IndexColumn is I+1,  nth1(IndexColumn, Board, Elem), not(isColumnFull(Elem)), write('Chose column '),writeln(IndexColumn), !.
